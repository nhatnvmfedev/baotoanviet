<?php
	...
	**/
    ...
    function theme_style() {
    	...
    	wp_enqueue_style( 'slick-css', THEME_URL_URI . '/assets/css/slick.css');
		wp_enqueue_style( 'default-css', THEME_URL_URI . '/assets/css/default.css');
		wp_enqueue_style( 'common-css', THEME_URL_URI . '/assets/css/common.css');
		wp_enqueue_style( 'cdn-ionicons', 'https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css');
	    wp_enqueue_style( 'style-main', THEME_URL_URI . '/assets/css/style-main.css');
	    wp_enqueue_style( 'news-single', THEME_URL_URI . '/assets/css/news-single.css');
		if (is_singular('product')) {
			wp_enqueue_style( 'popup-single', THEME_URL_URI . '/assets/css/jquery.modal.min.css');
			wp_enqueue_style( 'product-single', THEME_URL_URI . '/assets/css/product-single.css');
			wp_enqueue_style( 'fancybox-css', 'https://cdnjs.cloudflare.com/ajax/libs/fancybox/3.5.7/jquery.fancybox.min.css');
		}
	    wp_enqueue_script('jquery-lib', THEME_URL_URI . '/assets/js/jquery.min.js', array(), null, true);
	    wp_enqueue_script('config-min', THEME_URL_URI . '/assets/js/config.min.js', array(), null, true);
	    wp_enqueue_script('script-custom', THEME_URL_URI . '/assets/js/script.js', array(), null, true);
	    wp_enqueue_script('slick', THEME_URL_URI . '/assets/js/slick.min.js', array(), null, true);
	    if (is_singular('product')) {
	    	wp_enqueue_script('lib-popup-single', THEME_URL_URI . '/assets/js/jquery.modal.min.js', array(), null, true);
	    	wp_enqueue_script('tuts/js', esc_url( trailingslashit( get_template_directory_uri() ) . 'assets/js/no_js.js' ), null, true);
